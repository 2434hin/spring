...
public class SpringContainerTest {
	...
	public void collectionBeanTest() {
		...
		/***Then***/
		logger.debug("colectionBean.getList() : {}", collectionBean.getList());
		logger.debug("colectionBean.getSet() : {}", collectionBean.getSet());
		logger.debug("colectionBean.getMap() : {}", collectionBean.getMap());
		logger.debug("colectionBean.getProperties() : {}", collectionBean.getProperties());
